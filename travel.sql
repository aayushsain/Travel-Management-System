...
INSERT IGNORE INTO `contactus` (`contactid`, `Name`, `Phno`, `Email`, `Message`) VALUES
...
INSERT IGNORE INTO `enquiry` (`Enquiryid`, `Packageid`, `Name`, `Gender`, `Mobileno`, `Email`, `NoofDays`, `Child`, `Adults`, `Message`, `Statusfield`) VALUES
...
INSERT IGNORE INTO `package` (`Packid`, `Packname`, `Category`, `Subcategory`, `Packprice`, `Pic1`, `Pic2`, `Pic3`, `Detail`) VALUES
...
INSERT IGNORE INTO `subcategory` (`Subcatid`, `Subcatname`, `Catid`, `Pic`, `Detail`) VALUES
...
INSERT IGNORE INTO `users` (`Username`, `Pwd`, `Typeofuser`) VALUES
('admin', 'admin', 'Admin'),
('neeru','neeru','general'),
('manu','12345','Admin'),
('preet','preet','general');
